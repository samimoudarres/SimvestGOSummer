...
5. Store listings: privacy policy URL → `https://simvest-api.onrender.com/legal/privacy-policy.txt` (terms: `.../legal/terms-of-service.txt`; account deletion: `.../legal/delete-account.html`).
